    ...
    @php
        ...
        foreach($products  as $key => $product) {
            $data[$key] = [
                ...
                <a href="'.route('produtos.show', $product->id) .'" class="btn btn-xs btn-default text-teal mx-1 shadow" title="Detalhes">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-primary card-outline">
                <div class="card-header"> <a href="{{ route('produtos.create') }}" class="btn btn-sm btn-primary">
